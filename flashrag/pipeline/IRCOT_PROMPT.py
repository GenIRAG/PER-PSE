_2HOP_COMPARISON_PROMPT = """
    ...
    Thought: What's Inside was released in the year 1995. Cassandra's Dream (album) was released in the year 2008. Thus, of the two, the album to release earlier is What's Inside. So the answer is: What's Inside.
    =============================
    ...
    Thought: Martin Hodge was born on 4 February 1959. Ivania Martinich was born on 25 July 1995. Thus, Martin Hodge was born first. So the answer is: Martin Hodge.
    =============================
...
_2HOP_BRIDGE_PROMPT = """
    ...
    Thought: The film Hypocrite was directed by Miguel Morayta. Miguel Morayta died on 19 June 2013. So the answer is: 19 June 2013.
    =============================
    ...
    Thought: The South Korean television series in which Ryu Hye-young played Bo-ra is Reply 1988. The number of episodes Reply 1988 has is 20. So the answer is: 20.
    =============================
...
_2HOP_INFERENCE_PROMPT = """
    ...
    Thought: Krishna Shah has a child named Rudra Shah. Rudra Shah has a child named Prithvipati Shah. Thus, Krishna Shah has a grandchild named Prithvipati Shah. So the answer is: Prithvipati Shah.
    =============================
    ...
    Thought: Boraqchin is married to Ögedei Khan. Ögedei Khan's father is Genghis Khan. Thus, Boraqchin's father-in-law is Genghis Khan. So the answer is: Genghis Khan.
    =============================
...
_3HOP_BRIDGE_PROMPT = """
    ...
    Thought: Finding Dory is supposed to take place in California. The country that shares a border with California is Mexico. The length of the us border with Mexico is 1,989 mi. So the answer is: 1,989 mi.
    =============================
    ...
    Thought: The Crush Tour is performed by the band Bon Jovi. The record label of Bon Jovi is Island Records. The genre of Island Records is jazz. So the answer is: jazz.
    =============================
    ...
    Thought: The performer of Smoke in tha City is MC Eiht. MC Eiht's birthplace is Compton. Compton is located in the county of Los Angeles County. So the answer is: Los Angeles County.
    =============================

    Now it's your turn!
"""

_4HOP_BRIDGE_COMPARISON_PROMPT = """
    ...
    Thought: Coolie No. 1 (1995 film) was directed by David Dhawan. The Sensational Trial was directed by Karl Freund. David Dhawan's nationality is India. Karl Freund's nationality is Germany. Thus, they do not have the same nationality. So the answer is: no.
    =============================
    ...
    Thought: When The Mad Aunts Arrive was directed by Franz Josef Gottlieb. The Miracle Worker (1962 film) was directed by Arthur Penn. Franz Josef Gottlieb died on 23 July 2006. Arthur Penn died on September 28, 2010. Thus, of the two, the director to die earlier is Franz Josef Gottlieb, who directed When The Mad Aunts Arrive. So the answer is: When The Mad Aunts Arrive.
    =============================
...
_4HOP_BRIDGE_PROMPT = """
    ...
    Thought: The world series of poker take place in Las Vegas. Tony Hsieh owns the gold spike in Las Vegas. Tony Hsieh was educated at Harvard University. The enrollment of undergraduates at Harvard University is 7,200. So the answer is: 7,200.
    =============================
    ...
    Thought: The continent having Aruba is South America. The country having Loures is Portugal. The colonial holding in South America that was governed by Portugal is Brazil. The highest court in Brazil is Supreme Federal Tribunal (Supremo Tribunal Federal). So the answer is: Supreme Federal Tribunal (Supremo Tribunal Federal).
    =============================
    ...
    Thought: Pacific National University is located in Khabarovsk, Russia Khabarovsk, Russian is in the continent of Asia. The entity that mediated the truce which ended the Iran-Iraq War is the UN. The number of member states that UN recognises in Asia is 53. So the answer is: 53.
    =============================

    Now it's your turn!
"""

_4HOP_COMPARISON_PROMPT = """
    ...
    Thought: The date of birth of James A. Haley is January 4, 1899. The date of death of James A. Haley is August 6, 1981. The date of birth of William Goodsir is 12 January 1902. The date of death of William Goodsir is 14 July 1958. So the answer is: James A. Haley.
    =============================
    ...
    Thought: The date of birth of Constance Keys is 30 October 1886. The date of death of is Constance Keys 17 March 1964. The date of birth of Anthony de Jasay is 15 October 1925. The date of death of Anthony de Jasay is 23 January 2019. So the answer is: Anthony De Jasay.
    =============================
    ...
    Thought: The date of birth of Lon Myers is February 16, 1858. The date of death of Lon Myers is February 16, 1899. The date of birth of Antonio Superchi is 1 January 1816. The date of death of Antonio Superchi is 5 July 1893. So the answer is: Antonio Superchi.
    =============================
