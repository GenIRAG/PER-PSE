...
from flashrag.utils.utils import print_now, set_logger
...
class BasicPipeline:
    ...
    def evaluate(self, dataset, do_eval=True, save_file_name="intermediate_data.json", pred_process_fun=None):
        ...
        if do_eval:
            ...
            eval_result = self.evaluator.evaluate(dataset, save_file_name)
